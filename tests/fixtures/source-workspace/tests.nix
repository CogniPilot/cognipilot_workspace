...
assert
  builtins.sort builtins.lessThan plan.plans.packages.flight == [
    "codegen"
    "flight"
  ];
...
assert
  plan.repositories.codegen.git.clone.argv == [
    "git"
    "clone"
    "--origin"
    "origin"
...
assert
  plan.repositories.codegen.git.inspect.worktree.argv == [
    "git"
    "-C"
    "src/codegen"
    "rev-parse"
...
assert
  plan.repositories.codegen.git.inspect.origin.argv == [
    "git"
    "-C"
    "src/codegen"
    "remote"
...
assert
  plan.repositories.codegen.git.inspect.branch.argv == [
    "git"
    "-C"
    "src/codegen"
    "symbolic-ref"
...
assert
  plan.repositories.codegen.git.inspect.clean.argv == [
    "git"
    "-C"
    "src/codegen"
    "status"
...
assert
  plan.repositories.codegen.git.inspect.head.argv == [
    "git"
    "-C"
    "src/codegen"
    "rev-parse"
...
assert
  plan.repositories.codegen.git.inspect.target.argv == [
    "git"
    "-C"
    "src/codegen"
    "rev-parse"
...
assert
  plan.repositories.flight.git.fastForwardCheck.argv == [
    "git"
    "-C"
    "src/flight"
    "merge-base"
...
assert
  plan.repositories.flight.git.fastForward.argv == [
    "git"
    "-C"
    "src/flight"
    "merge"
...
assert
  plan.repositories.flight.git.rollback.refUpdate.argv == [
    {
      kind = "literal";
      value = "git";
    }
...
assert
  plan.repositories.flight.git.rollback.worktreeRestore.argv == [
    {
      kind = "literal";
      value = "git";
    }
...
assert
  plan.repositories.flight.git.rollback.refRestore.argv == [
    {
      kind = "literal";
      value = "git";
    }
